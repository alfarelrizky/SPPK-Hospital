<div class="card mb-4">
    <?php foreach ($data_edit as $edit) { ?>
        ...
        <div class="card-body">
            <form action='<?php echo base_url() . "latihan/edit_user" ?>' method='post'>
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group"><label class="small mb-1" for="inputFirstName">Katasandi</label>
                            <input class="form-password form-control py-4" type="text" placeholder="Masukan Katasandi Anda" name='katasandi' value='<?php echo $edit['katasandi_asli'] ?>' required />
                        </div>
                    </div>
                    <div class="col-md-3">
